...
<body>
  ...
  <br>
  <a href="dashboard.php" class="w3-bar-item w3-button-active" style="font-size: 18px; color: #009688;"><b>DASHBOARD</b></a>
...
<div class="w3-teal">
  ...
  <div class="w3-container">
    <h1>DASHBOARD  <i class="fa fa-dashboard" style="font-size:48px;color:white"></i></h1>
  </div>
</div>
...
<div class="container" style="margin-top: 6%;">
  ...
  <div class="panel-group">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading" style="text-align: center; font-size: 25px;">DASHBOARD</div>
